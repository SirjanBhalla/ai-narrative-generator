...
def get_region_narrative(region_yoy):
    region_data = region_yoy[
...
Below is region-level profitability data for a retail business comparing 
2026 performance against a 3-year historical average (2023-2025). 
Avg_Discount is the average discount rate applied to orders in that region.
...
1. What is happening?
   ...
   - Name specific regions, exact margins, and direction of change
...
3. What should be done?
   ...
   - Reference the contrast between the weakest and strongest region
...
Format rules:
   ...
   - The first sentence must name a specific region and a specific number
